...
export class QueenAttack {
    ...
    sameSpace () {
      if (this._queens.white[row] === this._queens.black[row] && this._queens.white[column] === this._queens.black[column]) {
    ...
    isValid() {
      ...
      this.sameSpace(this._queens.white, this._queens.black);
    }
